...
function speak(text) {
  ...
  console.log(speechSynthesis.getVoices()[8]);
  // Set the text.
  msg.text = text;
  ...
  console.log(parseFloat(volumeInput.value));
  console.log(parseFloat(rateInput.value));
  console.log(parseFloat(pitchInput.value));
